<template>
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <div v-else-if="errorMsg">
                <van-empty :description="errorMsg">
                  <van-button type="primary" @click="fetchTripData">
                    重新生成
                  </van-button>
                </van-empty>
            </div>
                    ...
                    :title="'第'+day.day+'天'">
                        <div class="day-schedule">
                            <div class="schedule-section">
                                <div class="section-label morning">早上</div>
        ...
        <div class="detail-footer" v-if="tripData && tripData.success!==false">
          <van-button type="primary" @click="goToChat" round class="primary-button" size="large">咨询AI助手</van-button>
        </div>
    </div>
</template>
